...
def mixed_checkpoint(func: Callable, inputs: dict, params: Sequence, flag: Optional[bool] = None):
    """
...
def checkpoint(func: Callable, inputs: dict, params: Sequence, flag: Optional[bool] = None):
    """
    Evaluate a function without caching intermediate activations, allowing for
...
class CheckpointFunction(torch.autograd.Function):
    ...
    @staticmethod
    def backward(ctx: Any, *output_grads):
